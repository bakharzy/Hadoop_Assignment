...
public class calcmin {
    ...
    public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, DoubleWritable> {
	    ...
	    double quartile = 4357676.996375395;
// Filtering the data is happeing here. If the value read from dataset is more than quartile value, then it is outputed from mapper for further calculations in reduce part.
            if(observation > quartile ){ 
...
//    Combiner
    ...
    public static class Combine extends MapReduceBase implements Reducer<Text, DoubleWritable, Text, DoubleWritable> {
        ...
        public void reduce(Text key, Iterator<DoubleWritable> values, OutputCollector<Text, DoubleWritable> output, Reporter reporter) throws IOException {
            ...
            double average = 9027230.275509289;
